...
- (void)layoutContentViewForCurrentOrientation:(UIView *)contentView animated:(BOOL)animated
{
	...
	if(UIInterfaceOrientationIsLandscape(self.interfaceOrientation)) {
		...
		(&ADBannerContentSizeIdentifierLandscape != nil) ? ADBannerContentSizeIdentifierLandscape : ADBannerContentSizeIdentifier480x32;
	} else {
		adBanner.currentContentSizeIdentifier =
		(&ADBannerContentSizeIdentifierPortrait != nil) ? ADBannerContentSizeIdentifierPortrait : ADBannerContentSizeIdentifier320x50;
	}
	...
	[UIView animateWithDuration:animationDuration
					 animations:^{
						 ...
						 adBanner.frame = CGRectMake(bannerOrigin.x,
													 bannerOrigin.y,
